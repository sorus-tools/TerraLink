...
- Minimum width for corridor feasibility
- **Note**: Currently informational; width is determined by connectivity mode
- **Default**: `1`
...
Linkscape offers two distinct strategies for corridor selection. Choose based on your conservation goals:
